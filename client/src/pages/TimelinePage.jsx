        ...
        <Box>
            ...
            <Box sx={{ display: 'flex', }}>
                ...
                <Box sx={{ width: '55%', height: '88vh', }}>
                    <Box sx={{ width: '100%', height: '20%', pt:'1.5%',bgcolor:'white', display:'flex',}}>
                            <Clips username={'Você'} />
                            <Clips username={'Você'} />
                            <Clips username={'Você'} />
                            <Clips username={'Você'} />
                ...
                <Box sx={{ width: '25%', height: '88vh', position: 'relative', zIndex: '2', bgcolor: 'white', pt: '30px', }}>
                    <Typography sx={{ color: '#673AB7', fontSize: '15px', mb: '15px', ml: '7px', fontWeight:'bold'}}>Sugestões para você</Typography>
                    <Box>
