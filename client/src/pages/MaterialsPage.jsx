import { Box, Button, Container, FormControl, Link, Modal, TextField, Typography, useMediaQuery } from '@mui/material'
            ...
            <Box display='flex' justifyContent='start' flexDirection='column' p={3} mt={5} width='100%' height='100%' fontSize={'1rem'}>
                <Container sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', width: '90%' }}>
                    ...
                    <Box sx={{ display: 'flex', alignItems: 'center', }}>
                        ...
                        <Box sx={{ height: '75%', bgcolor: '#673AB7', fontSize: '1rem', borderRadius: '3.1vh', color: 'white', padding: '0.3em 1em', ml: '2em', ':hover': { cursor: 'pointer', bgcolor: '#673AB7', opacity: '0.85' } }} onClick={handleOpen}>CRIAR PASTA</Box>
                    </Box>
                </Container>
