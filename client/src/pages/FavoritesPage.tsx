                    ...
                    <Box p={0} height={'100%'}>
                        <Box height={'100%'}>
                            <Card sx={{
                                ...
                                <Box display='flex' mb={2} sx={{ cursor: 'pointer', [theme.breakpoints.only('md')]: { width:'30%' } }} width={'22%'} onClick={handleOpen}>
                                    <Avatar sx={{ padding: '10px', margin: '10px', width: 20, height: 20, bgcolor: 'primary.main' }}>
                                        <Add sx={{ fontSize: '1em' }} />
                                    </Avatar>
                                    <Typography position={'relative'} top={8} sx={{ [ theme.breakpoints.only('lg')]: { top:10 , fontSize:'1.2rem' }, 
                                        [ theme.breakpoints.only('md')]: { top:11, fontSize:'1.1rem' } }}>Adicionar Pasta</Typography>
                                </Box>
