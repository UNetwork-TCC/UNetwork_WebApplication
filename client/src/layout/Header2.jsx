import { Box, Divider, Icon, IconButton, Typography, Container, InputBase } from '@mui/material'
...
export default function Header2() {
  ...
  return (
    <Box sx={{ width: '100vw', height: '8vh', display: 'flex', justifyContent: 'space-between', alignItems: 'center', p: '0px 30px' }} >
