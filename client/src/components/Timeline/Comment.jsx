    ...
    return (
        <Box sx={{width:'100%'}}>
            <Box sx={{ display: 'flex', alignItems:'center' }}>
                <AccountCircle sx={{fontSize:'35px', mr:'1%', color:'gray'}}/>
                <Box
                    component="form"
                    sx={matches ? { p: '0 0 0 10px', display: 'flex', width: '90%', height:25 ,border: '1px gray solid', borderRadius: '20px' } : { p: '0 0 0 6px', display: 'flex', width: 400, border: '1px gray solid', borderRadius: '20px' }}
                >
                    <InputBase
