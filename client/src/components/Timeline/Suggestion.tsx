...
export default function Suggestion({ username } : { username: string }): ReactElement {
    return (
        <Box display={'flex'} sx={{ width: '95%', height: '105px', bgcolor: 'white', borderRadius: '0 1.6vh 1.6vh 0', mb: '2vh' }}>
            ...
            <Box sx={{ width: '45%', height:'100%', display: 'flex', justifyContent: 'center', flexDirection: 'column' }}>
                ...
                <Typography 
                    sx={{ 
                        width:'90%',bgcolor:'#673AB7',
                        color:'white',
                        textAlign:'center' ,
                        textTransform: 'uppercase',
                        fontSize: '1.3vh',
                        border: '.2vh solid #673AB7',
                        borderRadius: '3.1vh',
                        padding:'0 .6vh', m:'10% 5% 0 5%',
                        ':hover':{ cursor:'pointer' } 
                    }}
                >Ver Perfil</Typography>
            </Box>
        </Box>
