...
export default function Suggestion({username}) {
    return (
        <Box display={'flex'} sx={{ width: '95%', height: '10.6vh', bgcolor: 'white', borderRadius: '0 1.6vh 1.6vh 0', mb: '2vh',}}>
            <Box sx={{ bgcolor: '#673AB7', width: '20%', borderRadius: '0 1.3vh 1.3vh 0px', m: '.6vh 0', }}>
                <IconButton size='small'>
                    <AccountCircle sx={{ fontSize: '9.1vh', color: 'white', position: 'absolute', left: '4.1vh', top: '-.5vh', margin: '0',  }} />
                </IconButton>
            </Box>
            ...
            <Box sx={{ width: '45%', height:'100%', display: 'flex', justifyContent: 'center', flexDirection: 'column'}}>
                <Box sx={{display:'flex',}}>
                    <Box sx={{ display: 'flex' }}>
                        <Favorite sx={{ fontSize: '2.3vh', ml:'.6vh', color:'red'}} />
                        <Typography sx={{ fontSize: '1.6vh', color: 'rgba(0,0,0,0.54)', ml:'.6vh' }}>X Likes</Typography>
                    </Box>
                    <Box sx={{ display: 'flex' }}>
                        <PhotoLibrary sx={{ fontSize: '2.3vh', ml:'1.1vh', color:'rgba(0,0,255,.70)'}} />
                        <Typography sx={{ fontSize: '1.6vh', color: 'rgba(0,0,0,0.54)', ml:'.6vh' }}>X Posts</Typography>
                    </Box>
                </Box>
