        ...
        <Box sx={{ width: '100%', mb:'2%'}}>
            ...
            <Box sx={{ml:'10px'}}>
                ...
                <Box sx={{ width: '100%', height: '8%', mb: '1%' }}>
                    <FavoriteBorder sx={{ fontSize: '3.6vh', mr: '30px', cursor: 'pointer', color: '#A0A9D0' }} />
                    <ChatBubbleOutline sx={{ fontSize: '3.6vh', mr: '30px', cursor: 'pointer', color: '#A0A9D0' }} />
                    <Reply sx={{ transform: 'scaleX(-1)', fontSize: '3.8vh', pb: '2px', cursor: 'pointer', color: '#A0A9D0', }} />
                </Box>
