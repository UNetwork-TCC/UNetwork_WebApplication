...
export default function FilterAndConfig({ text, handleOpen }) {
    ...
    return (
        <Box sx={{ display: 'flex', alignItems: 'center', }}>
            ...
            <Box sx={{ height: '75%', bgcolor: '#673AB7', fontSize: '1rem', borderRadius: '3.1vh', color: 'white', padding: '0.3em 1em', ml: '2em', ':hover': { cursor: 'pointer', bgcolor: '#673AB7', opacity: '0.85' } }} onClick={handleOpen}>{text}</Box>
            <CustomMenu
                anchorEl={anchorEl}
                open={open}
                onClose={handleClose}
