...
import { ForumSkeleton } from '@/layout/skeletons'
...
export default function Forum({
  ...
  const [contentTextLength, setContentTextLength] = useState<number | null>(
    forum?.description.length
  )
              ...
              >
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  ...
                  <Box sx={{ ml: '1rem' }}>
                    ...
                    <Typography sx={{ color: 'gray', fontSize: '1em' }}>
