...
export default function ForumIcon({
  ...
  return (
    <Box display="flex" width="calc(100vw - 120%)">
        ...
        >
          ...
          <Box display="flex" justifyContent="center" flexDirection="column">
            ...
            <Box gap={1} display="flex">
              ...
              <FormHelperText>
                {usersIn.length + ' Pessoas estão nesta discussão'}
              </FormHelperText>
            </Box>
          </Box>
        </Box>
      ...
      <CustomMenu anchorEl={anchorEl} open={menuOpen} onClose={handleMenuClose}>
      ...
      />
      <LoadingBackdrop open={openBackdrop} handleClose={() => {}} />
    </Box>
  )
}
