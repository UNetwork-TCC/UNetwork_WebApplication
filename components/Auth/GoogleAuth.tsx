...
export default function GoogleAuth(): ReactElement {
  ...
  const googleFailure = (error: any): void => {
    console.log(error)
    console.log(
      'Não foi possível logar com a Google. Tente novamente mais tarde.'
    )
  }
      ...
      <GoogleLogin
        render={renderProps => (
          <>
            ...
            >
              <img
                src="/assets/svg/Auth/GoogleLogo.svg"
      ...
      >
        <Box>
          <TextField
            ...
            label="RM"
            onChange={e => {
              setUserRM(e.currentTarget.value)
            }}
            value={userRM}
