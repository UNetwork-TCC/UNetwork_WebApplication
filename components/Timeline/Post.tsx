    ...
    <Box sx={{ width: '100%', mb: '2%' }}>
      <Box sx={{ width: '100%', height: '15%', display: 'flex' }}>
        <Box sx={{ display: 'flex', width: '100%' }}>
          <AccountCircle
            sx={{ fontSize: '90px', color: 'gray', width: '100px' }}
          />
          <Box sx={{ mt: '15px', ml: '1.5%' }}>
            <Typography sx={{ fontSize: '22px', fontWeight: 'bold' }}>
              {username}
            </Typography>
            <Typography sx={{ fontSize: '15px', color: 'rgba(0,0,0,.50)' }}>
              {data} • {date}
            </Typography>
          </Box>
        </Box>
      ...
      <Box sx={{ ml: '1.1vh' }}>
        <Box sx={{ width: '100%', mt: '.6vh' }}>
          ...
          >
            <Typography sx={{ fontSize: '35px', wordWrap: 'break-word' }}>
              ...
              dadada dua idad dada auda da dadada{' '}
            </Typography>
          </Box>
        </Box>
        ...
        <Box sx={{ width: '100%', height: '25%', display: 'flex', mb: '1.5%' }}>
          <Typography sx={{ fontSize: '18px', color: 'rgba(0,0,0,.70)' }}>
