...
export default function Post({
  ...
  const [contentTextLength, setContentTextLength] = useState(
    content?.text?.length
  )
  ...
  const handleShortcutModalClose = (): void => {
    setShortcutModalOpen(false)
  }
  const handleShortcutModalOpen = (): void => {
        ...
        >
          ...
          >
            <Box sx={{ display: 'flex' }}>
              ...
              >
                <UserAvatar user={user as User} isLoading={isLoading} />
                <Avatar
                  sx={{
                    position: 'relative',
                    height: '1.75rem',
            ...
            <IconButton
              onClick={e => {
                handleClick(
                  ...
                  [
                    onClickEvents.saveAsShortcut,
                    onClickEvents.favorite,
                    onClickEvents.follow,
                    onClickEvents.report,
                    onClickEvents.goToPost
                  ]
                )
              }}
              sx={{
          ...
          <Box width="100%" height="100%">
            ...
            >
              <Typography whiteSpace="pre-wrap" fontSize="1rem" variant="body1">
                {contentTextLength !== undefined && contentTextLength >= 999 ? (
                  <>
                    ...
                    <ArrowDropDown
                      sx={{ cursor: 'pointer' }}
                      onClick={() => {
                        setContentTextLength(undefined)
                      }}
                    />
                  </>
                ) : (
              ...
              >
                ...
                >
                  <Box display="flex" gap={2}>
                    ...
                    <Avatar
                      onClick={() => {
                        setDisplayMessageChat(prevState => !prevState)
                      }}
                      sx={{
                        bgcolor: 'background.paper',
                        [theme.breakpoints.down('md')]: {
