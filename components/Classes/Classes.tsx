...
export default function Classes({
  ...
  _class: { name: string; picture?: string; visibility?: 'public' | 'private' }
}): ReactElement {
  ...
  if (initials.length > 1) {
    ...
    const lettersInitial2 = initials[initials.length - 1]
      .charAt(0)
      .toUpperCase()
    ...
    <>
      ...
      >
        ...
        >
          <Avatar
            variant="square"
            sx={{ borderRadius: 2, height: '4.5rem', width: '4.5rem' }}
          >
            {_class.picture ? (
