...
export default function Footer(): ReactElement {
  ...
  const renderSection = (section: 'SECTION1' | 'SECTION2') => (
    ...
    >
      <Typography mb={2} fontWeight={900} color="primary.main" variant="h6">
      ...
      {['OPTION1', 'OPTION2', 'OPTION3'].map(option => (
        ...
        >
          {t(
            I18N.LANDING_PAGE.FOOTER[section][
              option as 'OPTION1' | 'OPTION2' | 'OPTION3'
            ]
          )}
        </Typography>
      ))}
    ...
    >
      ...
      >
        {!mobileMatches && (
          <Box width="20%">
            <Typography mb={2.5}>
              {t(I18N.LANDING_PAGE.FOOTER.COPYRIGHT)}
            </Typography>
