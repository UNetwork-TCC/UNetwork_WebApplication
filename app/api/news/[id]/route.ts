...
class NewsController extends BaseController {
  constructor(private newsRepository = new BaseRepository<INews>(News)) {
    super()
  }
  ...
  @Patch
  async updateNews(@Param('id') id: string, @Body() body: Partial<INews>) {
    return await this.newsRepository.update(id, body)
  }
