...
class GroupController extends BaseController {
  constructor(private groupRepository = new BaseRepository<IGroup>(Group)) {
    super()
  }
  ...
  @Patch
  async updateGroup(@Param('id') id: string, @Body() body: Partial<IGroup>) {
    return await this.groupRepository.update(id, body)
  }
