...
class MaterialController extends BaseController {
  constructor(
    private materialRepository = new BaseRepository<IMaterial>(Material)
  ) {
    super()
  }
  ...
  async fetchMaterials() {
    return await this.materialRepository.fetchAll()
  }

  @Post
  async createMaterial(@Body() body: MaterialDTO) {
    return await this.materialRepository.create(body)
  }
}
