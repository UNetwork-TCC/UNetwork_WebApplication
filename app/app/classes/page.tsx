...
export default function ClassesPage(): ReactElement {
  ...
  const createClass = (): void => {
    ...
    if (ClassAttributes.visibility && ClassAttributes.title) {
      setClass([...(_class as IClass[]), ClassAttributes as IClass])
      handleClose()
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Typography
            sx={{ fontSize: '2rem', color: '#673AB7', fontWeight: 'bold' }}
          >
            Suas Classes
          </Typography>
        ...
        >
          ...
          <Classes
            _class={{
              name: 'Maconheiros da paz e da guerra',
              visibility: 'public'
            }}
          />
          <Classes
            _class={{ name: 'Os programadores', visibility: 'public' }}
          />
      ...
      >
        <Box
          p={1}
          sx={{ width: '35vw', bgcolor: 'background.paper' }}
          borderRadius={2}
        >
