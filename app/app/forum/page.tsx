...
export default function ForumHome(): ReactElement {
  ...
  return (
    <>
        ...
        >
          <Box p={0}>
            <Typography
              ...
              component="h2"
              m={'1rem'}
              sx={{ fontSize: { lg: '1.5rem', xl: '1.5rem' } }}
            >
              Criar Fórum
            </Typography>
          </Box>
          <Box display="flex" flexDirection="column" p={2} gap={2}>
            ...
            <FormControl error={formErrors.topic}>
              ...
              >
                ...
                <MenuItem value="Trabalho/Atividade">
                  Trabalho/Atividade
                </MenuItem>
              ...
              <Box display="flex" gap={1} alignItems="center" flex={1}>
                <IconButton component="label" htmlFor="image">
                  <Avatar
                    sx={{
                      cursor: 'pointer',
                      bgcolor: image ? 'primary.main' : grey[400]
                    }}
                  >
                    <AddPhotoAlternate />
                  </Avatar>
      ...
      <LoadingBackdrop open={loadingOpen} handleClose={handleLoadingClose} />
    </>
  )
}
